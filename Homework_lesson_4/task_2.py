...
# Acum creează o nouă variabilă numită `name2` și seteaz-o la valoarea variabilei `name` și 
# afișează valoarea variabilei `name2` folosind funcția `print`
...
# CODUL TĂU VINE MAI JOS:
text = """Divide two numbers in Python.
...
# CODUL TĂU VINE MAI JOS:
f_string = f"Hello, my name is '{name}'! Also, name2 == {name2}."
print(f_string)
...
print(f_string[:len("Hello")] == "Hello")
...
# CODUL TĂU VINE MAI JOS:
format_str = "Hello, I'm {}. My friend's name is {} as well.".format(name, name2)
print(format_str)
