...
# CODUL TĂU VINE MAI JOS: 
print("Number + number3: ", number + number3)
print("Number - number3: ",number - number3)
print("Number * number3: ", number * number3)
print("Number / number3: ", number / number3)
print("Number % number3: ", number % number3)
...
# CODUL TĂU VINE MAI JOS:
print("Tipul variabilei 'number4' este: ", type(number4))
...
# CODUL TĂU VINE MAI JOS:
print("Tipul variabilei 'numar' este: ", type(numar))
...
# CODUL TĂU VINE MAI JOS:
print("Tipul variabilei 'numar_mare' este: ", type(numar_mare))
