...
# Acum schimbă valoarea variabilei `age` la vârsta prietenului tău și afișează valoarea variabilei `age` 
...
# Acum creează o nouă variabilă numită `age2` și seteaz-o la valoarea variabilei `age` și 
# afișează valoarea variabilei `age2` folosind funcția `print`
